          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup activecondition={pathname.includes('ecommerce')}>
               ...
               <li className={` py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('/AddStudent') && 'bg-slate-900'}`}>

                <NavLink
                  end
                  to="/AddStudent"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('/AddStudent') ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
                  <div className="flex items-center">
