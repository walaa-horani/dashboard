...
const EditOutDoors = () => {
    ...
    useEffect(() => {
      axios.get(`https://walaadashboard.pythonanywhere.com/api/outdoor/${id}/`)
  ...
  return (
    ...
    <h1 className=' display-5 text-center m-5'>Edit outdoor activity</h1>
