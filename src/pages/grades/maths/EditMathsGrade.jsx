...
const EditMathGrade = () => {
    ...
    useEffect(() => {
      axios.get(`https://walaadashboard.pythonanywhere.com/api/mathGradeDetails/${id}/`)
    ...
    function handleSubmit(e) {
      ...
      if (formIsValid) {
        ...
        axios.put(`https://walaadashboard.pythonanywhere.com/api/mathGradeDetails/${id}/`, data)
          .then(res => {
  ...
  return (
    ...
    <h1 className=' display-5 text-center m-5'>Edit a Math Grade</h1>
