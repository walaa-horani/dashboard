...
const EditHistoryGrade = () => {
    ...
    useEffect(() => {
      axios.get(`https://walaadashboard.pythonanywhere.com/api/chemistryGradeDetails/${id}/`)
    ...
    function handleSubmit(e) {
      ...
      if (formIsValid) {
        ...
        axios.put(`https://walaadashboard.pythonanywhere.com/api/chemistryGradeDetails/${id}/`, data)
          .then(res => {
